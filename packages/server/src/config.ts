...
export function warnIfDefaultPassword(cfg: RadioConfig, logger: pino.Logger): void {
...
export function updateFfmpegVersionInMemory(cfg: RadioConfig, version: string): void {
